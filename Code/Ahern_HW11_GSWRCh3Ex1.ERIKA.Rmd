...
library(ggplot2)
```
YOU NEED TO ADD THE HERE PACKAGE
```{r}
library(here)
```
...
```
YOU NEED TO RUN summary(DF) since you named the dataset DF on line 27. I'm renaming the DF compensation so that the rest of your code will run.
